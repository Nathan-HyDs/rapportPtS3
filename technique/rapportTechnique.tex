...
\chapter{La base de donnée}
    ...
    \begin{figure}[th]
      \begin{center}
        \includegraphics[scale=0.3]{Assets/MCD_Joueur.png}
    ...
    \begin{figure}[th]
      \begin{center}
        \includegraphics[scale=0.4]{Assets/MCD_Effet.png}
...
\subsection{Protocole de création d’un groupe}
  ...
  Sur l'organigramme en figure annexe~\ref{organiGroupe} est présenté la procédure de création d’un groupe de jeu sur le serveur et sa légende sur le tableau \ref{tabOrganigramme}.
...
\\
Le schéma en figure annexe~\ref{syncros} avec sa légende \textit{(Figure annexe~\ref{syncroslegende})} et ses étapes \textit{(Tableau~\ref{syncros})} illustre son fonctionnement.
